...
_a = Check;
Check.summary = 'Validate the theme.';
Check.descriptionWithMarkdown = `Calls and runs [Theme Check](https://shopify.dev/docs/themes/tools/theme-check) to analyze your theme code for errors and to ensure that it follows theme and Liquid best practices. [Learn more about the checks that Theme Check runs.](https://shopify.dev/docs/themes/tools/theme-check/checks)`;
Check.description = _a.descriptionWithoutMarkdown();
Check.flags = {
    ...globalFlags,
