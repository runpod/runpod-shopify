...
export async function packageTheme(inputDirectory) {
...
async function getThemePackageName(inputDirectory) {
    ...
    const themeInfo = parsedSettings.find((setting) => setting.name === 'theme_info');
