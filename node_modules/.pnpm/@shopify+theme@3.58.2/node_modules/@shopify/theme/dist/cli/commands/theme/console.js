...
_a = Console;
Console.summary = 'Shopify Liquid REPL (read-eval-print loop) tool';
Console.usage = ['theme:console', 'theme:console --url /products/classic-leather-jacket'];
Console.descriptionWithMarkdown = `Starts the Shopify Liquid REPL (read-eval-print loop) tool. This tool provides an interactive terminal interface for evaluating Liquid code and exploring Liquid objects, filters, and tags using real store data.

  You can also provide context to the console using a URL, as some Liquid objects are context-specific`;
Console.description = _a.descriptionWithoutMarkdown();
Console.flags = {
    ...globalFlags,
