...
class Publish extends ThemeCommand {
    async run() {
        const { flags, argv } = await this.parse(_a);
...
_a = Publish;
Publish.summary = 'Set a remote theme as the live theme.';
Publish.descriptionWithMarkdown = `Publishes an unpublished theme from your theme library.
...
Publish.description = _a.descriptionWithoutMarkdown();
