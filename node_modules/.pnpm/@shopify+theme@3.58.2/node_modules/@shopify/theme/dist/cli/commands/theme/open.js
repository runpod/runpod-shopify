...
_a = Open;
Open.summary = 'Opens the preview of your remote theme.';
Open.descriptionWithMarkdown = `Returns links that let you preview the specified theme. The following links are returned:
...
Open.description = _a.descriptionWithoutMarkdown();
Open.flags = {
    ...globalFlags,
