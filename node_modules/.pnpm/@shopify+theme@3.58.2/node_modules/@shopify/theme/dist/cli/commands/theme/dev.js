...
_a = Dev;
Dev.summary = 'Uploads the current theme as a development theme to the connected store, then prints theme editor and preview URLs to your terminal. While running, changes will push to the store in real time.';
Dev.descriptionWithMarkdown = `
...
Dev.description = _a.descriptionWithoutMarkdown();
Dev.flags = {
    ...globalFlags,
