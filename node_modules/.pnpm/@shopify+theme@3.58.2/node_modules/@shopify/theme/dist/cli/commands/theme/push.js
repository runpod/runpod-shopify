...
Push.usage = ['theme:push', 'theme:push --unpublished --json'];
Push.descriptionWithMarkdown = `Uploads your local theme files to Shopify, overwriting the remote version if specified.
  ...
  \`\`\`
    `;
Push.description = _a.descriptionWithoutMarkdown();
Push.flags = {
    ...globalFlags,
    ...themeFlags,
    theme: Flags.string({
...
async function confirmPushToLiveTheme(store) {
